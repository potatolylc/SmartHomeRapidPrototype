...
public class GeoLocationServiceImpl implements GeoLocationService {
	...
	public void logLocationInfo(String userName, String userWifiSsid,
		...
		int userSerialNum = this.userService.retrieveUserSerialNumByUserNameAndSsid(
							new UserValue(userName, userWifiSsid));
		this.geoLocationRepository.insertObject(new GeoLocationValue(longitude, latitude, new Date(), userSerialNum));
	}
}
